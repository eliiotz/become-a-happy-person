...
笛卡尔的论述有点绕，在这里我们将其整理成符合形式逻辑的推理过程：

+ 前提1.1-“灵魂”是一个在思维而没有广延的实体
+ 前提1.2-”肉体“是一个有广延（占据空间）而不可以思维的实体

+ 结论1-我们可以在完全不理解“肉体”的前提下理解“灵魂”
+ 前提2.1-对于对象A和B，如果可以在完全不理解B的前提下理解A，那么A和B一定是不同的

+ 结论2-“灵魂”和“肉体”是不同的

+ 前提3.1（隐含）-”我“在思维
+ 结论3-我的”灵魂“（在”我“中完成我的”肉体“所不能完成的”思维“这一动作的实体）是存在的

这段推理比前边的任何一段推理都要，似是而非。看上去有误的前提1.1和前提1.2都可以视作一种新的概念定义，即使将其替换为A和B也不会对推理产生影响。想要指出这段推理的谬误，我们需要尝试进一步揭示隐含的推理过程：

+ 前提4.1-单纯在思维 与 单纯有外延 是相互独立的特性

+ 前提4.2-如果相互独立的特性构成的集合F可以划分为集合FA和FB，使得FA与FB的交集为空，而并集为F，则具备特性集合F的实体一定可以划分为具有特性集合FA的实体A和具备特性集合FB的实体B
+ 前提4.3-“我”既在思维又有外延
+ 前提4.4-物质都有外延
+ 结论4-“我”可以划分为单纯在思维的非物质的A与单纯有外延的B
